# Rivera voice assistance created by aditya dand
...
def assistant(command):
    ...
    if 'open reddit' in command:
        ...
        talkToMe('opening telegram')
        os.system('telegram1')

    elif 'open system 32' in command:
        talkToMe('opening system 32')
        os.system('start system32')

    elif 'open cmd' in command:
        talkToMe('opening command prompt')
        os.system('start')
    ...
    elif 'hey rivera' in command:
        talkToMe('hey aditya how are you')
...
talkToMe('Initializing rivera')
talkToMe('rivera initialized')
